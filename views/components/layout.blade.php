...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary text-light">
            <header>
                <a class="navbar-brand" href="#">PTI FIT</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
              <ul class="navbar-nav">
                @if($user->role == 'aluno')
                <li class="nav-item">
                  <a class="nav-link" href="{{route('alunos.treino')}}">Meus treinos </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{route('alunos.show', $user->alunos->id)}}">Meu perfil</a>
                </li>
                @endif
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{route('professor.show', $user->professor->id)}}">Meu perfil</a>
                  </li>
